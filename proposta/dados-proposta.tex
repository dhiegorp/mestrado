...
\autor{Dhiego Ramos Pinto}

%%% CÓDIGO DO AUTOR DA PROPOSTA DE DISSERTAÇÃO
\codigoautor{SC 16107}
...
\titulo{Arquiteturas de Deep Learning aplicadas a Análise Estática de Malware}

%%% DATA DA APRESENTAÇÃO (formato {dd}{Mmmmm}{aaaa})
\dataapresentacao{31}{Dezembro}{2016}
...
% ---
\orientador{Julio Cesar Duarte}{D}
